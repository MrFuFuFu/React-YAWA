 ...
 */
public class WeatherActivity extends AppCompatActivity implements DefaultHardwareBackBtnHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String moduleName =  getIntent().getStringExtra("PageName");
        if (moduleName == null) {
